...
import farfadet from '../img/farfadet.png';
...
const Home = () => {
  ...
  return (
    ...
    <>
      ...
      <img src={farfadet} style={{scale: "0.3", position: "sticky", bottom: 0, left: 0, zIndex: 10, transform: "translate(-100%, 100%)", cursor: "pointer"}} onClick={() => alert("Je suis un farfadet malicieux, rempli d'espièglerie!!")} />
      </div>
